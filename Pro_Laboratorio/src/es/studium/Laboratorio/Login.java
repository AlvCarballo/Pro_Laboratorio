...
<<<<<<< HEAD
	...
	String url = "jdbc:mysql://localhost:3306/practica2laboratorio?useSSL=false";//jdbc:mysql:Direccion:puerto/NombreBasedeDatos?useSSL=False
	String usuario = "root";
	...
	public void actionPerformed(ActionEvent evento)
	{
		...
		else if(evento.getSource().equals(btnAceptar)) 
		{
			...
			try
			{
				...
				if(rs.next())
				{
					String u = rs.getString("tipoUsuario");
					String user= rs.getString("nombreUsuario");
					nombreUsuario= user;
					tipoUsuario= u;
					new MenuPrincipal(nombreUsuario, tipoUsuario);
					login.setVisible(false);
				}
				else
				{
