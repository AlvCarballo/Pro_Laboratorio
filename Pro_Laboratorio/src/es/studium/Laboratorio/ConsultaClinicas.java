...
<<<<<<< HEAD
	...
	public ConsultaClinicas(String UserName)
	{
		NombreUsuario=UserName;
		utilidad.registrarLog(NombreUsuario,"Entrando en Consulta Clinicas");
		...
		// Se crea el documento 
				...
				{ 
					...
					try 
					{
						...
						utilidad.registrarLog(NombreUsuario,"Archivo PDF Consulta Clinicas, generado y abierto Correctamente");
					}
					catch (IOException ex) 
					{
						System.out.println("Se ha producido un error al abrir el archivo PDF"); 
						utilidad.registrarLog(NombreUsuario,"Archivo PDF Consulta Clinicas, error al Abrir");
					}
				}
				catch ( Exception e ) 
				{ 
					System.out.println("Se ha producido un error al generar el archivo PDF");  
					utilidad.registrarLog(NombreUsuario,"Archivo PDF Consulta Clinicas, error al generar");
				}
	}
	@Override
	...
	{
		utilidad.registrarLog(NombreUsuario,"cerrando Consulta Clinicas");
=======
