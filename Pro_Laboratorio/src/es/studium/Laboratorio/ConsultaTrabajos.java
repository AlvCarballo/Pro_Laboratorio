...
public class ConsultaTrabajos extends JFrame implements WindowListener, ActionListener, ItemListener
{
	...
	public ConsultaTrabajos(String UserName)
	{
		...
		setVisible(true);
		utilidad.registrarLog(NombreUsuario,"Entrando en Consulta trabajos");
	...
	public void actionPerformed(ActionEvent arg0){
		...
		{ 
			...
			try 
			{
				...
				utilidad.registrarLog(NombreUsuario,"Archivo PDF Consulta Trabajos, generado y abierto Correctamente");
			}
			catch (IOException ex) 
			{
				//System.out.println("Se ha producido un error al abrir el archivo PDF"); 
				utilidad.registrarLog(NombreUsuario,"Archivo PDF Consulta Trabajos, error al Abrir");
			}
		}
		catch ( Exception e ) 
		{ 
			//System.out.println("Se ha producido un error al generar el archivo PDF"); 
			utilidad.registrarLog(NombreUsuario,"Archivo PDF Consulta Trabajos, error al generar");
		}
	}
	@Override
	...
	{
		utilidad.registrarLog(NombreUsuario,"cerrando Consulta Trabajos");
		setVisible(false);
	}
	@Override
