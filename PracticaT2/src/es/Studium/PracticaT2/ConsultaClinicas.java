...
public class ConsultaClinicas extends Frame implements WindowListener, ActionListener 
{
	...
	TextArea consulta = new TextArea(5,60);
	Button btnAceptar = new Button("Aceptar");
	Button btnPdf = new Button("Exportar a PDF");

	ConsultaClinicas()
	{
		setTitle("Consulta Clínicas");
